...
const EMOTION_SOUNDS: Record<Emotion, string[]> = {
  happy:        ['VeryHappySound'],
  excited:      ['ExcitedSound', 'ExcitedSound2'],
  loving:       ['AffectionSound'],
  playful:      ['CuteSound', 'Playful'],
  surprised:    ['ShockedSound'],
  curious:      ['CuriousSound', 'Curious2'],
  calm:         ['NeutralSound', 'NeutralSound2', 'NeutralSound3', 'NeutralSound4', 'NeutralSound5'],
  angry:        ['AngrySound', 'AngrySound2'],
  disgusted:    ['DisgustedSound'],
