...
![Nour](readme/nour-github-cover.png)
...
Nour is a living WebGL orb that reacts to the emotions in your voice in real time. Say something kind and it blooms with warm color, swells, and glows. Say something cruel and it shrinks, desaturates, and retreats. Neglect it long enough and it fades on its own. The soundscape is original too: **over 50 custom-made sounds** cover emotion hits, ambience, tricks, mini-game feedback, and UI moments—mixed in real time as you interact.

![Nour orb preview](readme/PreviewOrb.gif)
...
![Euphoria mode](readme/EuphoriaMode.gif)
...
![Lava lamp game](readme/GamePreview.gif)
...
├── readme/                       # README images (cover PNG + preview GIFs)
│
├── src/
...
│
└── public/
    ├── Nour Sounds/              # 50+ custom MP3s (emotions, ambience, tricks, game/UI)
